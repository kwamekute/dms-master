...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2019 at 11:42 AM
...
CREATE TABLE `branch` (
  ...
  `main_sub` enum('0','1') NOT NULL DEFAULT '0',
...
INSERT INTO `branch` (`branch_id`, `branch_name`, `branch_address`, `branch_contact`, `skin`, `main_sub`, `motto`, `created_at`, `updated_at`) VALUES
(5, 'Trust Hands Auto', 'Accra', '024567890', 'blue', '0', 'Think Automobile, Think Trust hands', '2019-12-14 14:25:46', NULL),
(10, 'Rognvaldr Automobile', 'some address', '0542546789', 'red', '1', 'this is the motto', '2019-12-15 01:44:43', NULL),
(15, 'Rognvaldr automobiles - Accra branch', 'some address', '0245689764', 'red', '0', 'something something', '2019-12-15 02:58:07', NULL);
...
(7, '', '', '', '', '0.00', 'default.gif', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '0.00', '', '', 5, '', '', '', '0000-00-00', 0, 0, 0, 0, 0),
(8, 'Rognvaldr', 'Mackay', 'aw 503/8 kasoa', '0542978514', '0.00', 'default.gif', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '0.00', '', '', 5, '', '', '', '0000-00-00', 0, 0, 0, 0, 0);
...
(18, 7, 'has logged in the system at ', '2019-12-10 03:07:49'),
(19, 7, 'has logged in the system at ', '2019-12-10 03:18:25'),
(20, 7, 'added 7 of Oil filter', '2019-12-10 11:19:50'),
(21, 7, 'has logged out the system at ', '2019-12-10 03:20:14'),
(22, 7, 'has logged in the system at ', '2019-12-10 18:31:55'),
(23, 7, 'has logged out the system at ', '2019-12-10 18:34:15'),
(24, 7, 'has logged in the system at ', '2019-12-10 21:00:36'),
(25, 7, 'added 3 of Oil filter', '2019-12-11 05:25:55'),
(26, 7, 'has logged out the system at ', '2019-12-10 21:56:34'),
(27, 7, 'has logged in the system at ', '2019-12-10 22:42:30'),
(28, 7, 'has logged in the system at ', '2019-12-12 11:46:13'),
(29, 4, 'has logged in the system at ', '2019-12-14 14:48:06'),
(30, 0, 'has logged out the system at ', '2019-12-14 19:01:08');

-- --------------------------------------------------------

--
-- Table structure for table `main_sub_branches`
--

CREATE TABLE `main_sub_branches` (
  `msb_id` int(11) NOT NULL,
...
--
-- Dumping data for table `main_sub_branches`
--

INSERT INTO `main_sub_branches` (`msb_id`, `main_id`, `sub_id`, `dateadded`) VALUES
(5, 10, 15, '2019-12-15 02:58:07');
...
(9, 2, 5, '2019-12-10', 0, 'pending'),
(10, 1, 5, '2019-12-10', 0, 'pending'),
(11, 2, 5, '2019-12-10', 0, 'pending'),
(12, 1, 5, '2019-12-10', 0, 'pending');
...
INSERT INTO `temp_trans` (`temp_trans_id`, `part_id`, `order_type_id`, `qty`, `date`) VALUES
(5, '', 0, 4, '2019-12-12');
...
INSERT INTO `user` (`user_id`, `username`, `password`, `name`, `status`, `role`, `branch_id`) VALUES
(1, 'admin', 'a1Bz20ydqelm8m1wql21232f297a57a5a743894a0e4a801fc3', 'John Smith', 'active', '0', 1),
(4, 'user', 'a1Bz20ydqelm8m1wql202cb962ac59075b964b07152d234b70', 'Mona Lisa', 'active', '0', 5),
(5, 'Mikee', 'a1Bz20ydqelm8m1wql70a5119905ec54b3edf78c6f515ac7b2', 'Mikee', 'active', '0', 1),
(6, 'administrator', 'a1Bz20ydqelm8m1wql21232f297a57a5a743894a0e4a801fc3', 'Giu Matthew', 'active', '0', 0),
(7, 'efisah', 'a1Bz20ydqelm8m1wql27df1a4128ee55e734aedfbc76335550', 'Efisah Buckman', 'active', '0', 5),
(8, 'sammy', 'a1Bz20ydqelm8m1wql91147d4c59f1406fb43e8fff487aa9cd', 'Samuel Gamor', 'active', '0', 6),
(9, 'mathew', 'a1Bz20ydqelm8m1wql8d10344331a7ac7665c83d8956bfc992', 'Mathew sekyi', 'active', '0', 7),
(10, 'John', 'a1Bz20ydqelm8m1wqle88b7c3574b9ba75e3fe19c74c205d24', 'John Jebo', 'active', '0', 8),
(11, 'rogn', '202cb962ac59075b964b07152d234b70', 'Rognvald Mackay', 'active', '1', 0),
(13, 'efisah', '81dc9bdb52d04dc20036dbd8313ed055', 'Efisah Buckman', 'active', '1', 10);
...
--
-- Indexes for table `main_sub_branches`
--
ALTER TABLE `main_sub_branches`
  ADD PRIMARY KEY (`msb_id`),
...
--
-- AUTO_INCREMENT for table `main_sub_branches`
--
ALTER TABLE `main_sub_branches`
  MODIFY `msb_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
